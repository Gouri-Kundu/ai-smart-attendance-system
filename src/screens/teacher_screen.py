...
def teacher_tab_manage_subjects():
    ...
    if subjects:
        for sub in subjects:
            subject_card(name=sub['name'], code=sub['subject_code'], section=sub['section'], students=sub['total_students'], classes=sub['total_classes'])
            
            if st.button(f"Share Code: {sub['name']}", key= f"share_{sub['subject_code']}", icon= ":material/share:", type= 'primary', width= 'stretch'):
...
def teacher_screen_login():
    ...
    teacher_username= st.text_input('Enter Username', placeholder= 'payelsingh')
    teacher_pass= st.text_input('Enter Password', placeholder= 'Pghyt@7890', type= 'password')
...
def teacher_screen_register():
    ...
    teacher_username= st.text_input('Enter Username', placeholder= 'payelsingh')
    teacher_name= st.text_input('Enter name', placeholder= 'Payel Singh')
    teacher_pass= st.text_input('Enter Password', placeholder= 'Pghyt@7890', type= 'password')
    teacher_pass_confirm= st.text_input('Confirm your Password', placeholder= 'Pghyt@7890', type= 'password')
